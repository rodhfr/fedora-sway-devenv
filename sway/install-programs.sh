...
# Setup rclone network drives
# those configs are available in gists
# /etc/rclone.conf
# https://gist.github.com/rodhfr/1cd727793b06080d091ba85d81e06726
# /etc/fstab
# https://gist.github.com/rodhfr/4321943bd72dfdc71b0033163ac86d33
# To mount without restarting computer
# sudo mount -a
